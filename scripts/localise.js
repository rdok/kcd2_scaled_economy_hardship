  ...
  try {
    ...
    for (const language in languageCodes) {
      ...
      try {
        ...
        const outputFilePath = path.join(outputDir, 'text_ui_soul__scaledeconomyhardship.xml');
...
const inputFilePath = path.join(__dirname, '..', 'src', 'Localization', 'text_ui_soul__scaledeconomyhardship.xml');
